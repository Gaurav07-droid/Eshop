...
exports.default = _default;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/basic-auth/node_modules/safe-buffer/index.js":[function(require,module,exports) {
...
},{"buffer":"../../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../../node_modules/basic-auth/index.js":[function(require,module,exports) {
...
},{"safe-buffer":"../../node_modules/basic-auth/node_modules/safe-buffer/index.js"}],"../../node_modules/ms/index.js":[function(require,module,exports) {
/**
 * Helpers.
 */
...
},{"./debug":"../../node_modules/debug/src/debug.js","process":"../../node_modules/process/browser.js"}],"../../node_modules/depd/lib/browser/index.js":[function(require,module,exports) {
/*!
 * depd
...
},{}],"../../node_modules/morgan/node_modules/on-finished/index.js":[function(require,module,exports) {
var process = require("process");
/*!
 * on-finished
...
},{"basic-auth":"../../node_modules/basic-auth/index.js","debug":"../../node_modules/debug/src/browser.js","depd":"../../node_modules/depd/lib/browser/index.js","on-finished":"../../node_modules/morgan/node_modules/on-finished/index.js","on-headers":"../../node_modules/on-headers/index.js","process":"../../node_modules/process/browser.js"}],"alert.js":[function(require,module,exports) {
"use strict";
...
exports.updatePassword = exports.updateMe = exports.signup = exports.resetPassword = exports.logout = exports.login = exports.forgotPassword = void 0;
...
var updatePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(currentPassword, newPassword, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            res = _context4.sent;
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Password has been updated!');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            res = _context5.sent;
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Profile has been updated!');
              window.setTimeout(function () {
                window.location.reload();
              }, 2000);
            }
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            res = _context6.sent;
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Token sent to mail!');
              window.setTimeout(function () {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(token, newPassword, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('success', _context7.t0.response.data.message);
          case 11:
          case "end":
...
},{"axios":"../../node_modules/axios/index.js","morgan":"../../node_modules/morgan/index.js","../js/alert":"alert.js"}],"cartAndOrder.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reviewAndRate = exports.removeFromCart = exports.addToCart = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("../js/alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var addToCart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(proId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:3000/api/v1/users/my-cart',
              data: {
                product: proId
              }
            });
          case 3:
            res = _context.sent;
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Product added to the cart');
              window.setTimeout(function () {
                window.location.assign('/api/v1/my-cart');
              }, 2000);
            }
            _context.next = 10;
            break;
          case 7:
            ...
            if (_context.t0.response.data.error.code === 11000) {
              (0, _alert.showAlert)('error', 'Product is already in the cart!');
            } else {
...
var removeFromCart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(proId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/cart/".concat(proId)
            });
          case 3:
            res = _context2.sent;
            if (res.status === 204) {
              (0, _alert.showAlert)('success', 'Product removed from the cart');
              window.setTimeout(function () {
                window.location.assign('/api/v1/my-cart');
              }, 2000);
            }
...
var reviewAndRate = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(proId, rating, review) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/products/".concat(proId, "/reviews"),
              data: {
                rating: rating,
                review: review
              }
          ...
          case 3:
            res = _context3.sent;
            if (res.status === 200) {
              (0, _alert.showAlert)('success', 'Thank you for your feedback!');
              window.setTimeout(function () {
                window.location.assign('/api/v1/my-cart');
              }, 2000);
            }
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            if (_context3.t0.response.data.error.name === 'ValidationError') {
              (0, _alert.showAlert)('error', 'You already given your feedback!');
              window.setTimeout(function () {
                window.location.assign('/api/v1/my-orders');
              }, 2000);
            } else {
              (0, _alert.showAlert)('error', 'Something went wrong!');
            }
  ...
  return function reviewAndRate(_x3, _x4, _x5) {
    return _ref3.apply(this, arguments);
  };
}();
exports.reviewAndRate = reviewAndRate;
},{"axios":"../../node_modules/axios/index.js","../js/alert":"alert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Ln0ePSALN1vrLI6bux8JP9hJfHQcRE1wiwDZ88aCi7303rQAhU8HGI3pdAGblguW66jps7ut2SERNaFCxH25MhX00n6WE8ce0');
var bookProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(prodId) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(prodId));
          case 3:
...
var _cartAndOrder = require("./cartAndOrder.js");
...
var formSaveData = document.querySelector('.form-user-data');
var formSavePassword = document.querySelector('.form-user-settings');
var formFeedback = document.getElementById('feedback');
var formForgotPass = document.getElementById('forgot-pass');
var formResetPass = document.getElementById('resetpass-form');
...
var inputPasswordConf = document.getElementById('password-confirm');
var inputPassCur = document.getElementById('password-current');
var inputRating = document.querySelector('.form-control');
var inputFeedback = document.getElementById('review');
var inputToken = document.getElementById('reset-token');
var btnAddToCart = document.querySelector('.btn-add-to-cart');
var btnRemoveFromCart = document.querySelectorAll('.btn-remove');
var btnBookProduct = document.getElementById('book-product');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/products?name=".concat(query)
            });
          case 3:
            res = _context.sent;
...
if (formSearch) formSearch.addEventListener('submit', function (e) {
  e.preventDefault();
  getSearchResults(inputSearch.value);
});
if (formLogin) formLogin.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _auth.login)(inputEmail.value, inputPassword.value);
});
if (formSignup) formSignup.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _auth.signup)(inputUsername.value, inputEmail.value, inputPassword.value, inputPasswordConf.value);
});
if (btnLogout) btnLogout.addEventListener('click', function () {
  (0, _auth.logout)();
});
if (btnAddToCart) btnAddToCart.addEventListener('click', function (e) {
  e.preventDefault();
  var proId = e.target.dataset.proid;
  (0, _cartAndOrder.addToCart)(proId);
});
if (btnRemoveFromCart) btnRemoveFromCart.forEach(function (el) {
  el.addEventListener('click', function (e) {
    e.preventDefault();
    var proId = e.target.dataset.proid;
    (0, _cartAndOrder.removeFromCart)(proId);
  });
});
if (btnBookProduct) btnBookProduct.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...';
  var proId = e.target.dataset.proid;
  (0, _stripe.bookProduct)(proId);
});
if (formSaveData) formSaveData.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (formSavePassword) formSavePassword.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _auth.updatePassword)(inputPassCur.value, inputPassword.value, inputPasswordConf.value);
});
if (formForgotPass) formForgotPass.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _auth.forgotPassword)(inputEmail.value);
});
if (formResetPass) formResetPass.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _auth.resetPassword)(inputToken.value, inputPassword.value, inputPasswordConf.value);
});
if (formFeedback) reviewBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var rating = +inputRating.value.split('s')[0];
  var proId = e.target.dataset.proid;
  (0, _cartAndOrder.reviewAndRate)(proId, rating, inputFeedback.value);
});
},{"axios":"../../node_modules/axios/index.js","./auth.js":"auth.js","./cartAndOrder.js":"cartAndOrder.js","./stripe.js":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
